...
export default function Header() {
  ...
  const isProd = typeof window !== 'undefined' && window.location.pathname.startsWith('/architect-portfolio');
  const prefix = isProd ? '/architect-portfolio' : '';
  return (
    <header className="w-full flex flex-col items-center mt-8 mb-8 select-none">
      ...
      {showAbout && (
        <div className="mt-4 flex flex-col items-center animate-fade-in">
          <Image src={getImagePath('/profilepic.jpg')} alt="Clementine Polsenaere" width={200} height={300} style={{ width: '200px', height: 'auto' }} />
